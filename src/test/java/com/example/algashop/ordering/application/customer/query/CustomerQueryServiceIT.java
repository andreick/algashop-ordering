...
class CustomerQueryServiceIT {
    ...
    void shouldFilterByPage() {
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
                .fullName(new FullName("Ana", "Silva")).build());
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
    ...
    void shouldFilterByEmail() {
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).email(new Email("user1@test.com"))
                .build());
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
                .email(new Email("test2@algashop.com")).build());
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId()).email(new Email("user3@test.com"))
                .build());
    ...
    void shouldFilterByMultipleParams() {
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
                .fullName(new FullName("John", "Doe")).email(new Email("johndoe@email.com")).build());
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
                .fullName(new FullName("Jane", "Doe")).email(new Email("janedoe@email.com")).build());
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
    ...
    void shouldOrderByFirstNameAsc() {
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
                .fullName(new FullName("Zoe", "Doe")).build());
        customers.add(CustomerTestDataBuilder.existingCustomer().id(new CustomerId())
