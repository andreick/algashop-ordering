...
import com.example.algashop.ordering.domain.model.shoppingcart.ShoppingCartTestDataBuilder;
...
@Sql(statements = "DELETE FROM shopping_cart_item; DELETE FROM shopping_cart")
class ShoppingCartUpdateProviderIT {
    ...
    void shouldUpdateItemPriceAndTotalAmount() {
        ShoppingCart shoppingCart = ShoppingCartTestDataBuilder.anEmptyCart().build();
