...
public class OrderPersistenceEntity extends AbstractAggregateRoot<CustomerPersistenceEntity> {
    ...
    public void replaceItems(@NonNull Set<OrderItemPersistenceEntity> items) {
        clearItems();
